    ...
    <div className="font-sans min-h-screen p-8 pb-20 sm:p-20">
      ...
      {loading ? (
        ...
        <>
          ...
          {totalPages > 1 && (
            <div className="flex justify-center gap-2 mt-4 sm:mt-4 md:mt-2 ">
              <button
                onClick={() => setCurrentPage((p) => Math.max(p - 1, 1))}
                disabled={currentPage === 1}
                className="px-1.5 py-1 sm:px-3 sm:py-1 md:px-3 md:py-1 rounded bg-gray-200 disabled:opacity-50"
              >
                Prev
              </button>
